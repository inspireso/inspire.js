define("inspire-js/1.0.1/index-debug", ["inspire-js/1.0.1/lib/submit-debug", "inspire-js/1.0.1/lib/checkbox-debug", "inspire-js/1.0.1/lib/confirm-debug", "inspire-js/1.0.1/lib/jump-debug", "inspire-js/1.0.1/lib/link-debug", "inspire-js/1.0.1/lib/money-debug", "inspire-js/1.0.1/lib/number-debug", "inspire-js/1.0.1/lib/pagination-debug", "inspire-js/1.0.1/lib/required-debug", "inspire-js/1.0.1/lib/roles-debug", "inspire-js/1.0.1/lib/trim-debug", "inspire-js/1.0.1/lib/validity-debug", "inspire-js/1.0.1/lib/dialog-debug", "inspire-js/1.0.1/lib/async-debug", "inspire-js/1.0.1/lib/typeahead-debug", "inspire-js/1.0.1/lib/messenger-debug"], function(require, exports, module) {
  ...
  exports.submit = require("inspire-js/1.0.1/lib/submit-debug");
  exports.trim = require("inspire-js/1.0.1/lib/trim-debug");
...
define("inspire-js/1.0.1/lib/checkbox-debug", [], function(require, exports, module) {
  /*!
   * checkbox.js
   *
   * https://github.com/inspireso
...
define("inspire-js/1.0.1/lib/confirm-debug", [], function(require, exports, module) {
  /*!
   * cinfirm.js
   *
   * https://github.com/inspireso
...
define("inspire-js/1.0.1/lib/jump-debug", [], function(require, exports, module) {
  /*!
   * jump.js
...
define("inspire-js/1.0.1/lib/link-debug", [], function(require, exports, module) {
  /*!
   * link.js
   *
   * https://github.com/inspireso
...
define("inspire-js/1.0.1/lib/money-debug", ["inspire-js/1.0.1/lib/number-debug"], function(require, exports, module) {
   ...
   */
  var $ = window.jQuery;
  var number = require("inspire-js/1.0.1/lib/number-debug");
...
define("inspire-js/1.0.1/lib/pagination-debug", [], function(require, exports, module) {
  /*!
   * pagination.js
   *
   * https://github.com/inspireso
...
define("inspire-js/1.0.1/lib/required-debug", [], function(require, exports, module) {
  /*!
   * required.js
   *
   * https://github.com/inspireso
...
define("inspire-js/1.0.1/lib/roles-debug", [], function(require, exports, module) {
  /*!
   * roles.js
   *
   * https://github.com/inspireso
...
define("inspire-js/1.0.1/lib/validity-debug", [], function(require, exports, module) {
  /*!
   * vaildity.js
   *
   * https://github.com/inspireso
...
define("inspire-js/1.0.1/lib/dialog-debug", [], function(require, exports, module) {
  /*!
   * dialog.js
   *
   * https://github.com/inspireso
...
define("inspire-js/1.0.1/lib/async-debug", [], function(require, exports, module) {
  /*!
   * async.js
   *
   * https://github.com/inspireso
